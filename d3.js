! function() {
    ...
    function d3_selection_on(type, listener, capture) {
        ...
        function removeAll() {
            var re = new RegExp("^__on([^.]+)" + d3v3.requote(type) + "$"),
                match;
    ...
    function d3_event_dragSuppress(node) {
        var name = ".dragsuppress-" + ++d3_event_dragId,
            click = "click" + name,
            w = d3v3.select(d3_window(node)).on("touchmove" + name, d3_eventPreventDefault).on("dragstart" + name, d3_eventPreventDefault).on("selectstart" + name, d3_eventPreventDefault);
    ...
    d3v3.behavior.drag = function() {
        var event = d3_eventDispatch(drag, "drag", "dragstart", "dragend"),
            origin = null,
            mousedown = dragstart(d3_noop, d3v3.mouse, d3_window, "mousemove", "mouseup"),
            touchstart = dragstart(d3_behavior_dragTouchId, d3v3.touch, d3_identity, "touchmove", "touchend");
        ...
        function dragstart(id, position, subject, move, end) {
            return function() {
                var that = this,
                    target = d3v3.event.target.correspondingElement || d3v3.event.target,
                    parent = that.parentNode,
                    dispatch = event.of(that, arguments),
                    dragged = 0,
                    dragId = id(),
                    dragName = ".drag" + (dragId == null ? "" : "-" + dragId),
                    dragOffset, dragSubject = d3v3.select(subject(target)).on(move + dragName, moved).on(end + dragName, ended),
    ...
    d3v3.behavior.zoom = function() {
                ...
                if (d3_transitionInheritId) {
                    d3v3.select(this).transition().each("start.zoom", function() {
                        ...
                        var dx = size[0],
                            ...
                            i = d3v3.interpolateZoom([(cx - view.x) / view.k, (cy - view.y) / view.k, dx / view.k], [(cx - view1.x) / view1.k, (cy - view1.y) / view1.k, dx / view1.k]);
                        return function(t) {
                            var l = i(t),
                                k = dx / l[2];
                            this.__chart__ = view = {
        ...
        function mousedowned() {
            var that = this,
                dispatch = event.of(that, arguments),
                dragged = 0,
                subject = d3v3.select(d3_window(that)).on(mousemove, moved).on(mouseup, ended),
                location0 = location(d3v3.mouse(that)),
        ...
        function touchstarted() {
            var that = this,
                ...
                locations0 = {},
                distance0 = 0,
                scale0, zoomName = ".zoom-" + d3v3.event.changedTouches[0].identifier,
                touchmove = "touchmove" + zoomName,
                touchend = "touchend" + zoomName,
                targets = [],
                subject = d3v3.select(that),
                dragRestore = d3_event_dragSuppress(that);
            started();
            zoomstarted(dispatch);
    ...
    function d3_xhr(url, mimeType, response, callback) {
        var xhr = {},
            dispatch = d3v3.dispatch("beforesend", "progress", "load", "error"),
            headers = {},
    ...
    function d3_locale_timeFormat(locale) {
        ...
        var d3_time_periodLookup = d3v3.map(),
    ...
    function d3_interpolate(a, b) {
        var i = d3v3.interpolators.length,
            f;
    ...
    d3v3.layout.force = function() {
        var force = {},
            event = d3v3.dispatch("start", "tick", "end"),
            timer, size = [1, 1],
    ...
    d3v3.layout.partition = function() {
        var hierarchy = d3v3.layout.hierarchy(),
            size = [1, 1];
    ...
    var d3_layout_stackOrders = d3v3.map({
        "inside-out": function(data) {
            var n = data.length,
                ...
                index = d3v3.range(n).sort(function(a, b) {
                    return max[a] - max[b];
                }),
                top = 0,
                bottom = 0,
    ...
    d3v3.layout.pack = function() {
        var hierarchy = d3v3.layout.hierarchy().sort(d3_layout_packSort),
            padding = 0,
            size = [1, 1],
            radius;
    ...
    d3v3.layout.tree = function() {
        var hierarchy = d3v3.layout.hierarchy().sort(null).value(null),
    ...
    function d3_scale_log(linear, base, positive, domain) {
        ...
        scale.tickFormat = function(n, format) {
            ...
            else if (typeof format !== "function") format = d3v3.format(format);
        ...
        function axis(g) {
            g.each(function() {
                ...
                var ticks = tickValues == null ? scale1.ticks ? scale1.ticks.apply(scale1, tickArguments_) : scale1.domain() : tickValues,
                    ...
                    tickExit = d3v3.transition(tick.exit()).style("opacity", ε).remove(),
                    tickUpdate = d3v3.transition(tick.order()).style("opacity", 1),
    ...
    d3v3.svg.brush = function() {
        ...
        function brushstart() {
            var target = this,
                ...
                dragRestore = d3_event_dragSuppress(target),
                center, origin = d3v3.mouse(target),
                offset;
    ...
    function d3_time_scale(linear, methods, format) {
        ...
        function tickMethod(extent, count) {
            var span = extent[1] - extent[0],
                target = span / count,
                i = d3v3.bisect(d3_time_scaleSteps, target);
    ...
    if (typeof define === "function" && define.amd) this.d3v3 = d3v3, define(d3v3);
    else if (typeof module === "object" && module.exports) module.exports = d3v3;
    else this.d3v3 = d3v3;
}();